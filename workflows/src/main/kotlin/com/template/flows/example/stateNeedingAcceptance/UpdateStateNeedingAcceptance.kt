...
@InitiatingFlow
@StartableByRPC
class UpdateStateNeedingAcceptance(
    ...
    override fun call() {
        ...
        transactionBuilder.addCommand(StateNeedingAcceptanceContract.Commands.Update(), signers)
...
@InitiatedBy(UpdateStateNeedingAcceptance::class)
class UpdateStateNeedingAcceptanceResponder(
